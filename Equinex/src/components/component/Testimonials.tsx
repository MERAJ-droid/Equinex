...
const Testimonials: React.FC = () => {
  const testimonials = [
    {
      quote: "EquineX has completely transformed how we connect with investors. We secured our seed funding in just 3 weeks!",
      name: "Sarah Johnson",
      title: "Founder, NeuralLink AI"
    },
    {
      quote: "The transparency and security offered by EquineX gave us confidence to invest in early-stage startups we might have otherwise overlooked.",
      name: "Michael Chen",
      title: "Angel Investor"
    },
    {
      quote: "As a first-time founder, navigating venture funding seemed impossible until I found EquineX. Their platform made the process seamless.",
      name: "Aisha Patel",
    ...
    {
      quote: "We've invested in 5 startups through EquineX and have seen an average ROI of 32% - the platform's analytics tools are game-changing.",
      name: "Jennifer Wu",
      title: "Investment Director, Horizon Ventures"
    },
    {
      quote: "The KYC process was refreshingly straightforward. EquineX has found the perfect balance between security and user experience.",
      name: "Thomas Müller",
